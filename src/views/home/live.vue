      ...
      <div class="head_con">
        <div class="banner_left">
          ...
          <div class="banner_btn">
            <div @click="externalJumpFn(url.douyu)" class="btn_one">
              <img src="@/assets/images/douyu.png" alt="" />
              {{ erkeLive.info.room_title || erkeLive.msg }}
            </div>
          </div>
          <p>
            查询时间：{{ utilTime(erkeLive.check_time) }}
            显示的图像仅用于展示作用
          </p>
        </div>
      </div>
      <div class="home_bg">
        <div style="max-width: 230px; flex: 1; margin: 0 auto; position: relative">
          <div>
            ...
            <div class="video_wrap" @click="externalJumpFn(url.douyu)">
              <div class="animate-wave">
                <div
                  :style="
                    'background-image: url(' +
                    (erkeLive.info.cover_pic ? erkeLive.info.cover_pic : url.backImg) +
                    ')'
                  "
                  class="logo"
                ></div>
...
import { utilTime } from "@/utils/util";

export default {
  data() {
    return {
      url: {
        douyu: "https://www.douyu.com/78622",
        backImg:
          "https://img.douyucdn.cn/data/yuba/weibo/2023/01/29/202301291721386043550652722.png",
      },
      erkeLive: {
        info: {},
      },
