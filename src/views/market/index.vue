  ...
  <div class="big_wrap">
    ...
    <div class="invest_list clearfix">
      <div class="list_title font_Bold clearfix" style="display: flex;" id="list_title">
        本站可播放音乐
        <el-button type="primary" class="button mg-lt-10" style="background:#f4c8c7;color:#000; font-weight:400; border-color:#f4c8c7;" @click="jumpFun('music')">跳转播放页查看更多</el-button>
      </div>
          ...
          <el-card shadow="hover">
            ...
            <div class="invest_list_r pointer">
              ...
              <div class="bottom clearfix">
                <el-button type="primary" class="button" @click="jumpFun('music',item.id)" style="background:#f4c8c7; font-weight:400; border-color:#f4c8c7;">播放</el-button>
              </div>
            </div>
          </el-card>
        </el-col>
